...
export default function UserLoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      // const url = `${API_ENDPOINTS.AUTH.LOGIN_USER}?username=${encodeURIComponent(data.username)}&password=${encodeURIComponent(data.password)}`
      //
      // // Make API request with POST method as specified in the controller
      // const response = await axios.post(url)

      const response = await axios.post(API_ENDPOINTS.AUTH.LOGIN_USER, {
